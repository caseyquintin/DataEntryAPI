...
window.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        initializeDataTableAndHandlers(); // 💡 Called only ONCE!

        // ✅ Attach sidebar toggle here too
        ...
        // ✅ Your other dropdown event handlers (port change, vessel line change, etc.) can remain here
        // Just make sure they are not inside a second $(document).ready()
