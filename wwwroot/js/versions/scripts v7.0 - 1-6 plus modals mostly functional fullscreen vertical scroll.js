...
function initializeContainerTable () {
    ...
    const table = $('#ContainerList').DataTable({
        ...
        columns: [
            ...
            { data: 'shiplineID', name: 'shiplineID', className: 'editable' },
            ...
            { data: 'fpmID', name: 'fpmID', visible: true },
            ...
            { data: 'vesselLineID', name: 'vesselLineID', visible: true },
            { data: 'vesselName', name: 'vesselName', className: 'editable' },
            { data: 'vesselID', name: 'vesselID', visible: true },
            ...
            { data: 'portID', name: 'portID', visible: true },
            { data: 'terminal', name: 'terminal', className: 'editable' },
            { data: 'terminalID', name: 'terminalID', visible: true },
            ...
            { data: 'carrierID', name: 'carrierID', className: 'editable' },
            ...
            { data: 'lastUpdated', name: 'lastUpdated', className: 'editable', render: data => data ? new Date(data).toLocaleDateString() : '' }
        ],
